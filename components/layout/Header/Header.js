    ...
    return (
        ...
        <div className={`${styles.d_header}`}>
            <div className={`${styles.d_header_top}`}>
                <div className={`${styles.d_header_logo}`}>
                    <Link className={`${styles.logo_home_link}`} href="./"><Image width={313} height={195} src="/static/images/hsl_logo.png"/></Link>
                </div>
        ...
        <div className={styles.d_header_m}>
            <div className={styles.d_logo_m}>
                <Image className={styles.logo_m} src="/static/images/hsl_logo.png" width={104} height={65} />
            </div>
                    ...
                    <li className={styles.pagelist_item_m}>
                        <div className={styles.pagelist_link_m}>SERVICES
                            <ul className={styles.services_list_m}>
                                ...
                                <li className={styles.service_item_m}><Link className={styles.service_item_link_m} href="../services/oral-history">Oral History Projects</Link></li>
                                <li className={styles.service_item_m}><Link className={styles.service_item_link_m} href="../services/published-works">Published Works</Link></li>
