    ...
    return (
        ...
        <div className={styles.d_footer}>
            <div className={styles.d_footer_contact}>
                <p className={styles.footer_contact}>Contact Charles at <Link href="mailto:cphilips5509@gmail.com" className={styles.footer_link}>cphilips5509@gmail.com</Link> or 843-532-6327</p>
            </div>
            ...
            <div className={styles.d_footer_copyright}>
                <p className={styles.footer_copyright}>
                    Charles Philips | Historic Studies Limited © 2023-{currentYear}
                </p>
            </div>
        </div>
        </>
