...
const PubWorks = () => {
    const mobile_goes_title = "As Mobile Goes, So Goes the Corps";
    ...
    const us_water_title = "U.S. Bureau of Reclamation Water Conveyance Systems in the West Context and Evaluation Guidance."
