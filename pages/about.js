            ...
            <div className={`${styles.d_encompass}`}>
                ...
                <div className={`${styles.d_cards}`}>
                    <div className={`${styles.d_card}`}>
                        <Imagecard_l imageurl={"/images/people/CFP_library_ded.jpg"} imagealt={"A photo of Charles Philips"} height={405} width={335} title={"Charles F. Philips, Jr."} text={aboutCharlesPhilips}/>
                    </div>
                    <div className={`${styles.d_card}`}>
                        <Imagecard_r imageurl={"/images/about/CFP_presentation.jpg"} imagealt={"Charles Philips Vitae"} height={420} width={454} title={"HSL's Work"} text={charlesPhilipsWork}/>
                    </div>
                </div>
